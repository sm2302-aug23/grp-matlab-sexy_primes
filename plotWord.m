...
x_a = [1.4 1 0.5 1 1.4 1.3 1.5 1.8];
y_a = [1 1.5 0.5 0.3 1 0.4 0.4 1];

x_b = [0.9 1.2 1.2 0.9 0.8 0.85 1.1 1.3 1.2 1.15 1.35 1.6];
y_b = [1 1.8 2.2 1.2 0.5 0.2 0.2 0.8 1.2 0.9 0.6 1];

x_c = [1.4 1.3 1 0.9 1.25 1.6];
y_c = [1 1.3 1 0.3 0.2 1];

x_d = [1.3 1.1 0.7 0.8 1.2 1.6 1.6 1.3 1.5 1.8];
y_d = [1 1.2 0.55 0.1 0.5 1.6 2.1 0.5 0.3 1];

x_e = [0.7 1.4 0.8 0.7 1.25 1.8];
y_e = [1 1.5 1.2 0.2 0.2 1];

x_f = [1 1.25 1.2 0.9 0.9 1.05 1 1.2 1.6];
y_f = [1 1.8 2.2 0.6 -0.1 0.1 1 0.5 1];

x_g = [1.3 1 0.8 0.95 1.2 1.3 1.2 0.9 1.3 1.7];
y_g = [1 1.1 0.5 0.2 0.5 1 -0.5 -0.8 0.1 1];

x_h = [0.9 1.2 1.2 0.9 0.8 0.85 1 1.25 1.25 1.4 1.6];
y_h = [1 1.8 2.2 1.2 0.5 0.2 0.9 0.9 0.25 0.25 1];

x_i = [0.9 0.8 0.9 1.2];
y_i = [1 0.5 0.2 1];

x_j = [1.35 1.2 1 1 1.3 1.7];
y_j = [1 -0.5 -0.8 -0.5 0 1];

x_k = [0.9 1.2 1.2 0.9 0.8 0.85 1 1.25 1.15 1 1.25 1.6];
